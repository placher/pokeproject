...
void Sprite::move()
{
    ...
    if( ( mPosX < 0 ) || ( mPosX + Sprite_WIDTH + 5 > SCREEN_WIDTH ) )
    {
        //Move back
        mPosX -= mVelX;
    }
    ...
    if( ( mPosY < 0 ) || ( mPosY + Sprite_HEIGHT + 10 > SCREEN_HEIGHT ) )
    {
        //Move back
        mPosY -= mVelY;
    }
...
{
    //Show the Sprite
	gSpriteTexture.render( mPosX, mPosY );
}
...
bool loadMedia()
{
	...
	//Load dot texture
	if( !gSpriteTexture.loadFromFile( "dSchmieder.png" ) )
	{
